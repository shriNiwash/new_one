...
const PortfolioCategories = ()=>{
    ...
    <div className="page_header">
            <h4 className="table_h4">PortfolioCategories</h4>
            <ul className="table_ul">
                ...
                <li className="home_datas"><a>PortfolioCategories Page</a></li>
                <li className="seprator_data"><i className="fa fa-angle-right"></i></li>
                <li className="home_datas"><a href="">PortfolioCategories</a></li>
            </ul>
        </div> 
        <div className="row">
                ...
                <div className="table_header">
                    <div className="row">
                        ...
                        <div className="col-lg-4 offset-lg-1 mt-2 mt-lg-0">
                            <a href="" className="btn btn-primary float-right btn-sm" id="float_rigth" data-bs-toggle="modal" data-bs-target="#Portfolioexample"><i className="fa fa-plus"></i>Add Portfolio Categories</a>
                        </div>
                    </div>
                </div>
                                            ...
                                            <table className="table table-light table-striped  mt-3 " id="shri-table">
                                                ...
                                                <tbody>
                                                  <tr>
                                                    ...
                                                    <td>MISC</td>
                                                    <td> <span className="btn btn-success">Active</span></td>                                                  
                                                    <td>3</td>                                                  
