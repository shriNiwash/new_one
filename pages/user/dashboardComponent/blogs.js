...
const Blogs = () => {
  return (<>
          ...
          <div className="table_header">
            <div className="row">
              ...
              <div className="col-lg-4 offset-lg-1 mt-2 mt-lg-0">
                <a href="" className="btn btn-primary float-right btn-sm" id="float_rigth" data-bs-toggle="modal" data-bs-target="#exampleModalblogsservices"><i className="fa fa-plus"></i>Add Blog</a>
              </div>
            </div>
          </div>
    ...
    <div className="modal fade" id="exampleModalblogsservices" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <form>
